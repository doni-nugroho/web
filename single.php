...
$row_img = mysqli_fetch_assoc($hasil);
?>
			...
			<div class="new-product">
				<div class="col-md-5 zoom-grid">
					<div class="flexslider">
						<ul class="slides">
							<li data-thumb="images/dridenim/<?php echo ($row_img['gambar']); ?>">
								<div class="thumb-image"> <img src="images/dridenim/<?php echo ($row_img['gambar']); ?>" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li>
							<?php if ($row_img['gambar2'] != null){ ?>
							<li data-thumb="images/dridenim/<?php echo ($row_img['gambar2']); ?>">
								<div class="thumb-image"> <img src="images/dridenim/<?php echo ($row_img['gambar2']); ?>" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li>
							<?php } ?>
							<?php if ($row_img['gambar3'] != null){ ?>
							<li data-thumb="images/dridenim/<?php echo ($row_img['gambar3']); ?>">
							<div class="thumb-image"> <img src="images/dridenim/<?php echo ($row_img['gambar3']); ?>" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li>
							<?php } ?>
				...
				<div class="col-md-7 dress-info">
					<div class="dress-name">
						<h3><?php echo ($row_img['nama_produk']); ?></h3>
						<span>Rp<?php echo ($row_img['harga']); ?></span>
					...
					<div class="purchase">
						<a href="add_to_cart.php?act=add&amp;barang_id=<?php echo $_GET["id"];?>&amp;ref=single.php?id=<?php echo $_GET["id"]?>">Purchase Now</a>
